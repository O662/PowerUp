...
public class AutoFindVisionTarget extends Command {
...
*/
	 ...
	 */
    public AutoFindVisionTarget(double forwardSpeed, double rotateSpeed) {
    ...
    protected void execute() {
    	if (System.currentTimeMillis() - pidTimeSinceUpdate > pidUpdateDelay) {
    		setPointAngle = Robot.visionTarget.pidGet();
        	Robot.navx.zeroYaw();
