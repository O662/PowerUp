...
public class AutoDriveAtAngleNavxPID extends Command {
	...
	public AutoDriveAtAngleNavxPID(double distance, double setPointAngle) {
		this(distance, 0.7, setPointAngle);
	}

	public AutoDriveAtAngleNavxPID(double distance, double speed, double setPointAngle) {
		this(distance, speed, false, 0, 0, setPointAngle);
	}

	public AutoDriveAtAngleNavxPID(double distance, double speed, boolean limit, double limitDistance, double limitSpeed, double setPointAngle) {
