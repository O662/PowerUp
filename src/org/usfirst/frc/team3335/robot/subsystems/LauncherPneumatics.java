...
public class LauncherPneumatics extends Subsystem {
	...
	public LauncherPneumatics () {
		...
		solenoidCenter = new DoubleSolenoid(RobotMap.LAUNCHER_CENTER_FORWARD_CHANNEL, RobotMap.LAUNCHER_CENTER_REVERSE_CHANNEL);
		setSolenoidValue(DoubleSolenoid.Value.kOff);
		solenoidRight = new DoubleSolenoid(RobotMap.LAUNCHER_RIGHT_FORWARD_CHANNEL, RobotMap.LAUNCHER_RIGHT_REVERSE_CHANNEL);
		setSolenoidValue(DoubleSolenoid.Value.kOff);
